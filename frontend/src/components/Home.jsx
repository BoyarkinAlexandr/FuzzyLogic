...
const methods = [
  ...
  { id: 5, name: "Основных операции нечетких множеств", description: "Краткое описание метода 5. Этот метод помогает в задачах с искусственным интеллектом.", imageUrl: "", link: "/fuzzycalculator" }
];
